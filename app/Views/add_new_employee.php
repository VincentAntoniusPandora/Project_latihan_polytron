    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            ...
            <div class="form-group ">
                ...
                <input type="text" name="employee_name" class="form-control" id="formGroupExampleInput"
            ...
            <div class="mb-3">
                ...
                <br>
                <input class="form-control" type="file" id="formFile" name="employee_picture"
                    onchange="imageUpload(event)" hidden>
                <div class="container" style="position:relative; display:inline-block;">
                    <label type="btn" for="formFile" style="position:relative; display:inline-block;">
                        <img src="/img/add image.png" alt="" id="chg-img" width="100px" height="100px"
                            style="cursor: pointer; border-radius: 20px; object-fit:cover;">
                        <i class="fa-solid fa-plus"
                            style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); font-size:30px">
                        </i>
            ...
            <div class="form-group ">
                ...
                <input type="text" name="employee_phone" class="form-control" id="formGroupExampleInput"
...
; color: white;">Add Employee</button>
            <a type="submit" href="/employeeList/<?= $company_id ?>" class="btn btn-outline"
